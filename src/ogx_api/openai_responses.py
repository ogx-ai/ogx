...
@json_schema_type
class ShellContainerAutoEnvironment(BaseModel):
    """Automatically provisions a container for the shell tool."""
...
@json_schema_type
class ShellContainerReferenceEnvironment(BaseModel):
...
class OpenAIResponseInputToolShell(BaseModel):
    """Shell tool configuration for executing commands in a container environment.

    :param type: Tool type identifier, always "shell"
    :param environment: (Optional) The container environment to use
    """

    type: Literal["shell"] = "shell"
    environment: ShellContainerAutoEnvironment | ShellContainerReferenceEnvironment | None = None
...
class ShellOutputContent(BaseModel):
    ...
    stdout: str
    stderr: str
    outcome: ShellExitOutcome | ShellTimeoutOutcome


@json_schema_type
class OpenAIResponseOutputMessageShellCall(BaseModel):
    """A tool call that executes one or more shell commands in a managed environment.

    :param id: Unique identifier for the shell tool call
    :param call_id: The unique ID of the shell tool call generated by the model
    :param action: The shell commands and limits
    :param status: The status of the shell call
    :param type: Item type identifier, always "shell_call"
    """
    ...
    environment: ShellContainerReferenceEnvironment | None = None
    created_by: str | None = None


@json_schema_type
class OpenAIResponseOutputMessageShellCallOutput(BaseModel):
    """The output of a shell tool call that was emitted.

    :param id: Unique identifier for the shell call output
    :param call_id: The unique ID of the shell tool call generated by the model
    :param output: An array of shell call output contents
    :param status: The status of the shell call output
    :param type: Item type identifier, always "shell_call_output"
    """

    id: str
    call_id: str
    output: list[ShellOutputContent]
