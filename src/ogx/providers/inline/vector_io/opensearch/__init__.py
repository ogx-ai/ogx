...
from ogx.providers.remote.vector_io.opensearch.config import OpenSearchVectorIOConfig
...
async def get_provider_impl(
    ...
    from ogx.providers.remote.vector_io.opensearch.opensearch import OpenSearchVectorIOAdapter
