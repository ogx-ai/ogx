...
from ogx.telemetry import setup_telemetry
from ogx_api import (
    Api,
    Batches,
    Connectors,
...
class Stack:
    ...
    async def initialize(self):
        # Configure metrics export when a stack is brought up (server or library mode).
        # Kept here rather than at import so non-serving commands (e.g. `ogx stack list-deps`)
