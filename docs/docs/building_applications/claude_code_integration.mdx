...
- Anthropic (the `anthropic` provider), including extended thinking
...
|----------|-------------------|------------------|----------------|-------|
| **Anthropic** | ✅ | ✅ | ✅ | Requests are forwarded to `/v1/messages` unchanged, so everything Claude Code sends works |
