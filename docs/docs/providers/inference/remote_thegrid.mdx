...
sidebar_label: Remote - Thegrid
title: remote::thegrid
---
...
The Grid AI inference provider for accessing market-priced inference instruments via The Grid AI API.
...
| `base_url` | `HttpUrl \| None` | No | https://api.thegrid.ai/v1 | Base URL for The Grid AI API |

## Sample Configuration

```yaml
base_url: https://api.thegrid.ai/v1
api_key: ${env.THEGRID_API_KEY:=}
```
