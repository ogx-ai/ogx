...
xAI inference provider for accessing Grok models via the xAI API.
...
| `base_url` | `HttpUrl \| None` | No | https://api.x.ai/v1 | Base URL for the xAI API |
