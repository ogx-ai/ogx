...
Novita AI inference provider for accessing a broad catalog of open models via Novita's OpenAI-compatible API.
...
| `base_url` | `HttpUrl \| None` | No | https://api.novita.ai/openai | Base URL for the Novita API |
